...
const Slide07IkigaiExample = () => (
  <ScaledSlide>
    <h2 className="text-3xl font-bold text-foreground mb-4 text-center">
      이키가이(Ikigai) 벤다이어그램 — 나만의 콘텐츠 교차점 찾기 (모과 버전)
    </h2>
    <div className="flex-1 flex items-center justify-center relative">
      {/* Left-top text block */}
      <div className="absolute left-0 top-0 w-[320px] text-right pr-6 pt-2">
        <p className="text-sm font-bold text-slide-cream mb-2">좋아하는 것</p>
      ...
      <div className="absolute right-0 top-0 w-[340px] pl-6 pt-2">
        <p className="text-sm font-bold text-slide-cream mb-2">잘하는 것</p>
        <p className="text-xs text-foreground/80 leading-relaxed">
          설명·강의·1:1 소통<br/>
          개인 능력 파악 후 역할 배분<br/>
          전체 그림 그리기·기획·전략<br/>
      ...
      <div className="absolute left-0 bottom-0 w-[340px] text-right pr-6 pb-2">
        <p className="text-sm font-bold text-slide-cream mb-2">세상에 필요한 것</p>
        <p className="text-xs text-foreground/80 leading-relaxed">
          방향을 잡지 못한 1인 사업자·소상공인을 위한 마케팅 전략<br/>
      ...
      <div className="absolute right-0 bottom-0 w-[320px] pl-6 pb-2">
        <p className="text-sm font-bold text-slide-cream mb-2">돈을 벌 수 있는 것</p>
        <p className="text-xs text-foreground/80 leading-relaxed">
